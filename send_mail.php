...
try {
    ...
    //Recipients
    $mail->setFrom('samarthsingh60@gmail.com', 'Mailer');         //Set the sender of the message (your email address)
    $mail->addAddress('Samarthsinghrathore60@gmail.com', 'Joe User');     //Add a recipient (your bae's email address)
